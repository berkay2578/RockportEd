...
namespace ImGui {
   ...
   IMGUI_API void			TextWrappedColored(const ImVec4& col, const char* fmt, ...) IM_PRINTFARGS(2);
   ...
   IMGUI_API bool          SliderUInt(const char* label, unsigned int* v, unsigned int v_min, unsigned int v_max, const char* display_format = "%.0f");
